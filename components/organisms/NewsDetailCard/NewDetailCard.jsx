    ...
    return (
        <div className="max-w-2xl p-6 bg-white rounded-lg ">
            ...
            <div className="flex row justify-between align-middle">
                ...
                <div>
                    <div className="w-80 flex justify-end gap-4 content-center">
                        <p className="text-xs my-auto">Compartir en:</p>
                        <div className="flex row gap-4">
                            <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.tusitio.com/articulo" target="_blank">
                            ...
                            <a href={`https://api.whatsapp.com/send?text=https://elinformador.vercel.app/NewsDetail/${id}`} target="_blank">
                                <div className="w-10 h-10">

...
export const SocialBar = () => {
    return (
        <div className="mb-7 flex justify-center">
            <div className=' p-2 w-full shadow-md shadow-bottom flex justify-center '>
                <div className="w-80 flex justify-center gap-4 content-center">
                    <p className="text-xs my-auto">Compartir en:</p>
                    <div className="flex row gap-4">
                        <a href={`https://www.facebook.com/sharer/sharer.php?u=https://www.informadorsincensura.com.co`} target="_blank">
                        ...
                        <a href={`https://api.whatsapp.com/send?text=https://www.informadorsincensura.com.co`} target="_blank">
